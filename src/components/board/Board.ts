...
export interface Board{
    ...
    setPWMFrequency(pin: string, frequencyHz: number, extra?: Extra): Promise<void>;
    readAnalogReader(boardName: string, analogReader: string, extra?: Extra): Promise<number>;
    getDigitalInterruptValue
    (boardName: string, digitalInteruptName: string, extra?: Extra): Promise<number>;
}
