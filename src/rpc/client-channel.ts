...
interface activeClienStream<M extends DescMethod> {
  cs: ClientStream<M>;
}

export class ClientChannel extends BaseChannel implements Transport {
  private streamIDCounter = 0;
  private readonly streams = new Map<string, activeClienStream<DescMethod>>();
  ...
  >(
    ClientCtor: ClientStreamConstructor<T, M, I, O>,
    stream: Stream,
    method: M,
  ...
  public async unary<I extends DescMessage, O extends DescMessage>(
    ...
    return this.newStream<UnaryClientStream<I, O>, DescMethodUnary<I, O>, I, O>(
  ...
  public async stream<I extends DescMessage, O extends DescMessage>(
    ...
    return this.newStream<
      ...
      DescMethodStreaming<I, O>,
      I,
      O
    >(StreamClientStream<I, O>, this.nextStreamID(), method, header).run(
      signal,
      timeoutMs,
      input,
      contextValues
