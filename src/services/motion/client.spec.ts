...
describe('moveOnGlobe', () => {
  ...
  it('allows optionally specifying heading, obstacles, motionConfig & extra', async () => {
    ...
    const expectedObstaclesList: GeoGeometry[] = [
      create(GeoGeometrySchema, {
    ...
    const expectedBoundingRegionsList: GeoGeometry[] = [
      create(GeoGeometrySchema, {
...
describe('move', () => {
  it('sends a move request with pseudolinear constraints', async () => {
    ...
    const expectedPseudolinearConstraint: PseudolinearConstraint = create(
      PseudolinearConstraintSchema,
      {
