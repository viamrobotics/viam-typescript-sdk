...
test('end getPcdMap stream with wrong code', () => {
  ...
  // @ts-expect-error We need to pass "undefined" as a second argument here, but it gets removed by the linter since omitted an argument is equivalent to passing in "undefined"
