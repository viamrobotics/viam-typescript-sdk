...
import type { BinaryReadOptions, Extension, FieldList, FieldOptions, FileOptions, JsonReadOptions, JsonValue, MessageOptions, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
 ...
 */
export declare class ResourceDescriptor extends Message<ResourceDescriptor> {
  /**
 ...
 */
export declare class ResourceReference extends Message<ResourceReference> {
  /**
 ...
 */
export declare const resource_reference: Extension<FieldOptions, ResourceReference>;
 ...
 */
export declare const resource_definition: Extension<FileOptions, ResourceDescriptor[]>;
 ...
 */
export declare const resource: Extension<MessageOptions, ResourceDescriptor>;
