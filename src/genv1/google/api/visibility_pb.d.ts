...
import type { BinaryReadOptions, EnumOptions, EnumValueOptions, Extension, FieldList, FieldOptions, JsonReadOptions, JsonValue, MessageOptions, MethodOptions, PartialMessage, PlainMessage, ServiceOptions } from "@bufbuild/protobuf";
 ...
 */
export declare const enum_visibility: Extension<EnumOptions, VisibilityRule>;
 ...
 */
export declare const value_visibility: Extension<EnumValueOptions, VisibilityRule>;
 ...
 */
export declare const field_visibility: Extension<FieldOptions, VisibilityRule>;
 ...
 */
export declare const message_visibility: Extension<MessageOptions, VisibilityRule>;
 ...
 */
export declare const method_visibility: Extension<MethodOptions, VisibilityRule>;
 ...
 */
export declare const api_visibility: Extension<ServiceOptions, VisibilityRule>;
