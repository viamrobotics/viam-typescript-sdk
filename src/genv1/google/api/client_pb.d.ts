...
import type { BinaryReadOptions, Duration, Extension, FieldList, JsonReadOptions, JsonValue, MethodOptions, PartialMessage, PlainMessage, ServiceOptions } from "@bufbuild/protobuf";
 ...
 */
export declare class PythonSettings_ExperimentalFeatures extends Message<PythonSettings_ExperimentalFeatures> {
  /**
 ...
 */
export declare class SelectiveGapicGeneration extends Message<SelectiveGapicGeneration> {
  /**
 ...
 */
export declare class BatchingConfigProto extends Message<BatchingConfigProto> {
  /**
  ...
  constructor(data?: PartialMessage<BatchingConfigProto>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "google.api.BatchingConfigProto";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BatchingConfigProto;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): BatchingConfigProto;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): BatchingConfigProto;

  static equals(a: BatchingConfigProto | PlainMessage<BatchingConfigProto> | undefined, b: BatchingConfigProto | PlainMessage<BatchingConfigProto> | undefined): boolean;
}
 ...
 */
export declare class BatchingSettingsProto extends Message<BatchingSettingsProto> {
  /**
  ...
  constructor(data?: PartialMessage<BatchingSettingsProto>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "google.api.BatchingSettingsProto";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BatchingSettingsProto;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): BatchingSettingsProto;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): BatchingSettingsProto;

  static equals(a: BatchingSettingsProto | PlainMessage<BatchingSettingsProto> | undefined, b: BatchingSettingsProto | PlainMessage<BatchingSettingsProto> | undefined): boolean;
}
 ...
 */
export declare class BatchingDescriptorProto extends Message<BatchingDescriptorProto> {
  /**
  ...
  constructor(data?: PartialMessage<BatchingDescriptorProto>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "google.api.BatchingDescriptorProto";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): BatchingDescriptorProto;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): BatchingDescriptorProto;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): BatchingDescriptorProto;

  static equals(a: BatchingDescriptorProto | PlainMessage<BatchingDescriptorProto> | undefined, b: BatchingDescriptorProto | PlainMessage<BatchingDescriptorProto> | undefined): boolean;
}
 ...
 */
export declare const method_signature: Extension<MethodOptions, string[]>;
 ...
 */
export declare const default_host: Extension<ServiceOptions, string>;
