 ...
 */
export const Constant = /*@__PURE__*/ proto3.makeMessageType(
 ...
 */
export const SourceInfo_Extension = /*@__PURE__*/ proto3.makeMessageType(
  ...
  {localName: "SourceInfo_Extension"},
);
 ...
 */
export const SourceInfo_Extension_Component = /*@__PURE__*/ proto3.makeEnum(
  "google.api.expr.v1alpha1.SourceInfo.Extension.Component",
  [
    {no: 0, name: "COMPONENT_UNSPECIFIED", localName: "UNSPECIFIED"},
    {no: 1, name: "COMPONENT_PARSER", localName: "PARSER"},
    {no: 2, name: "COMPONENT_TYPE_CHECKER", localName: "TYPE_CHECKER"},
    {no: 3, name: "COMPONENT_RUNTIME", localName: "RUNTIME"},
  ],
);
 ...
 */
export const SourceInfo_Extension_Version = /*@__PURE__*/ proto3.makeMessageType(
  ...
  {localName: "SourceInfo_Extension_Version"},
);
