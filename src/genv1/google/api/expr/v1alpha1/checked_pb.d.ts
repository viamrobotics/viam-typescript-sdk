...
import type { BinaryReadOptions, Empty, FieldList, JsonReadOptions, JsonValue, NullValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
 ...
 */
export declare class CheckedExpr extends Message<CheckedExpr> {
  /**
 ...
 */
export declare class Type_ListType extends Message<Type_ListType> {
  /**
   * The element type.
   *
 ...
 */
export declare class Type_MapType extends Message<Type_MapType> {
  /**
   * The type of the key.
   *
 ...
 */
export declare class Type_FunctionType extends Message<Type_FunctionType> {
  /**
 ...
 */
export declare class Type_AbstractType extends Message<Type_AbstractType> {
  /**
 ...
 */
export declare class Decl_IdentDecl extends Message<Decl_IdentDecl> {
  /**
 ...
 */
export declare class Decl_FunctionDecl extends Message<Decl_FunctionDecl> {
  /**
 ...
 */
export declare class Decl_FunctionDecl_Overload extends Message<Decl_FunctionDecl_Overload> {
  /**
