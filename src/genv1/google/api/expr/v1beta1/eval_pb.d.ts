 ...
 */
export declare class EvalState extends Message<EvalState> {
  /**
 ...
 */
export declare class EvalState_Result extends Message<EvalState_Result> {
  /**
 ...
 */
export declare class ExprValue extends Message<ExprValue> {
  /**
 ...
 */
export declare class ErrorSet extends Message<ErrorSet> {
  /**
 ...
 */
export declare class UnknownSet extends Message<UnknownSet> {
  /**
 ...
 */
export declare class IdRef extends Message<IdRef> {
  /**
   * The expression id.
   *
