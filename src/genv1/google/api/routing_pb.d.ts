...
export declare class RoutingRule extends Message<RoutingRule> {
  ...
  static readonly typeName = "google.api.RoutingRule";
 ...
 */
export declare class RoutingParameter extends Message<RoutingParameter> {
  /**
  ...
  constructor(data?: PartialMessage<RoutingParameter>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "google.api.RoutingParameter";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RoutingParameter;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RoutingParameter;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RoutingParameter;

  static equals(a: RoutingParameter | PlainMessage<RoutingParameter> | undefined, b: RoutingParameter | PlainMessage<RoutingParameter> | undefined): boolean;
}
 ...
 */
export declare const routing: Extension<MethodOptions, RoutingRule>;
