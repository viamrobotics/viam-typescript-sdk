 ...
 */
export declare const ByteStream: {
  readonly typeName: "google.bytestream.ByteStream",
  readonly methods: {
    /**
     ...
     */
    readonly queryWriteStatus: {
      readonly name: "QueryWriteStatus",
      readonly I: typeof QueryWriteStatusRequest,
      readonly O: typeof QueryWriteStatusResponse,
