...
import type { Any, BinaryReadOptions, Duration, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage, Struct, Timestamp } from "@bufbuild/protobuf";
 ...
 */
export declare class AttributeContext_Api extends Message<AttributeContext_Api> {
  /**
 ...
 */
export declare class AttributeContext_Auth extends Message<AttributeContext_Auth> {
  /**
 ...
 */
export declare class AttributeContext_Response extends Message<AttributeContext_Response> {
  /**
 ...
 */
export declare class AttributeContext_Resource extends Message<AttributeContext_Resource> {
  /**
