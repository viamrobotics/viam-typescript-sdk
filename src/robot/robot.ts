...
export type CloudMetadata = DeepOmitProtobufInternals<proto.GetCloudMetadataResponse>;
export type ConfigStatus = DeepOmitProtobufInternals<proto.ConfigStatus>;
export type FrameSystemConfig = DeepOmitProtobufInternals<proto.FrameSystemConfig>;
export type JobStatus = DeepOmitProtobufInternals<proto.JobStatus>;
export type MachineStatus = DeepOmitProtobufInternals<proto.GetMachineStatusResponse>;
export type MachineStatusState = proto.GetMachineStatusResponse_State;
export type ModuleModel = DeepOmitProtobufInternals<proto.ModuleModel>;
export type ResourceRPCSubtype = DeepOmitProtobufInternals<proto.ResourceRPCSubtype>;
export type ResourceStatus = DeepOmitProtobufInternals<proto.ResourceStatus>;
export type Session = DeepOmitProtobufInternals<proto.Session>;
export type Operation = DeepOmitProtobufInternals<proto.Operation>;
