...
build-buf: $(node_modules) clean-buf
	...
	$(buf) generate https://github.com/JohnN193/api.git\#branch=edit-maps --path proto/viam/common,proto/viam/component,proto/viam/robot,proto/viam/service,proto/viam/app
